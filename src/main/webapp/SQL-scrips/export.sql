...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "BOOKSHOP"."SEQUENCE_AUTHOR"  MINVALUE 1 MAXVALUE 9999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
REM INSERTING into BOOKSHOP.AUTHOR
SET DEFINE OFF;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "BOOKSHOP"."AUTHOR_PK" ON "BOOKSHOP"."AUTHOR" ("ID_AUTHOR") 
...
--------------------------------------------------------
  ...
  ALTER TABLE "BOOKSHOP"."AUTHOR" ADD CONSTRAINT "AUTHOR_PK" PRIMARY KEY ("ID_AUTHOR")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "BOOKSHOP"."AUTHOR" MODIFY ("ID_AUTHOR" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "BOOKSHOP"."PROPERTIES" ADD CONSTRAINT "PROPERTIES_PK" PRIMARY KEY ("ID_BOOK")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "BOOKSHOP"."PROPERTIES" ADD CONSTRAINT "PROPERTIES_FK1" FOREIGN KEY ("ID_AUTHOR")
	  REFERENCES "BOOKSHOP"."AUTHOR" ("ID_AUTHOR") ENABLE;
--------------------------------------------------------
--  DDL for Trigger TR_NEW_AUTHOR
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "BOOKSHOP"."TR_NEW_AUTHOR" 
...
END;
/
ALTER TRIGGER "BOOKSHOP"."TR_NEW_AUTHOR" ENABLE;
--------------------------------------------------------
