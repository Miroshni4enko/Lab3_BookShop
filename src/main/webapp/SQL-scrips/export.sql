...
--------------------------------------------------------
  ...
  TABLESPACE "USERS" ;
   ...
   COMMENT ON COLUMN "ITEM"."DESCRIPTION" IS '0- if it is book,1-rubric,2-section';
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "ORDERS_PK" ON "ORDERS" ("ID_ORDER", "ID_CUSTOMER", "ID_CONTENT")
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "ORDERS_INDEX1" ON "ORDERS" ("ID_CONTENT")
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  ALTER TABLE "ORDERS" ADD CONSTRAINT "ORDERS_UK1" UNIQUE ("ID_CONTENT")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "ORDERS" MODIFY ("ID_CONTENT" NOT NULL ENABLE);
  ALTER TABLE "ORDERS" MODIFY ("ID_CUSTOMER" NOT NULL ENABLE);
  ALTER TABLE "ORDERS" ADD CONSTRAINT "ORDERS_PK" PRIMARY KEY ("ID_ORDER", "ID_CUSTOMER", "ID_CONTENT")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "CONTENR_ORDER" ADD CONSTRAINT "CONTENR_ORDER_PK" PRIMARY KEY ("ID_CONTENT", "ID_BOOK", "ID_ORDER")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "CONTENR_ORDER" ADD CONSTRAINT "CONTENR_ORDER_FK1" FOREIGN KEY ("ID_CONTENT")
	  REFERENCES "ORDERS" ("ID_CONTENT") ENABLE;
  ALTER TABLE "CONTENR_ORDER" ADD CONSTRAINT "CONTENR_ORDER_FK2" FOREIGN KEY ("ID_BOOK")
	  REFERENCES "ITEM" ("ID_ITEM") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "PROPERTIES" ADD CONSTRAINT "PROPERTIES_FK1" FOREIGN KEY ("ID_AUTHOR")
	  REFERENCES "AUTHOR" ("ID_AUTHOR") ENABLE;
--------------------------------------------------------
